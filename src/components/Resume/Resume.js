        ...
        <div className={classes.category}>
          ...
          <div className={classes.items}>
            <div className={classes.item}>
              ...
              <p>As a UX Engineer, it was my responsibility to promote easy and intuitive user interfaces for our products. This includes design work, research (market, technical, audience), usability studies, AB testing, and more to validate our user experience strategies.</p>
              <p>As a Scrum Master, I facilitated and created opportunities each sprint for the team to succeed. I consistently researched, analyzed, and experimented to ensure our Scrum process runs smoothly and without interruption so the team could focus on reaching their goals.</p>
            </div>
            ...
            <div className={classes.item}>
              ...
              <p>As a Web Administrator, I maintained a cloud-hosted LAMP stack which hosts approximately a dozen separate sites. I engineered solutions for our cloud-hosted stack to securely communicate with locally hosted resources in an efficient manor.</p>
              <p>As a Web Developer, I developed a custom Content Management System (CMS) in PHP to showcase our custom-built homes on the web. Through storyboarding and market research, I designed a visually stunning web front-end. The front-end was built on top of the CMS in HTML 5 and JavaScript. Additionally, I developed standalone web applications for large touchscreen kiosks in several of our physical sales centers.</p>
            </div>
        ...
        <div className={classes.category}>
          ...
          <div className={classes.items}>
            <div className={classes.item}>
              ...
              <p>I studied Technology at Illinois State University because I enjoy learning about a wide variety of topics. The technology program offerred opportunities to explore computer operating systems and hardware, networking, electronics, and programming, instead of focusing on just one specific area. This allowed me to hone in on the topics I found the most interesting as I moved into my professional career, while also having a well-rounded background to attack any problem I encountered critically.</p>
              <p>I also participated in several activities and societies while at Illinois State. I am an alumnus of Phi Mu Alpha Sinfonia and I was a member of the drumline in the Big Red Marching Machine.</p>
            </div>
          </div>
        </div>
