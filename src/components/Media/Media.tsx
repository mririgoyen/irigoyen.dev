      ...
      <div className={classes.items}>
        <div className={classes.item}>
          ...
          <div className={classes.info}>
            ...
            <p>I sat down with <a href='https://twitter.com/philhawthorne' rel='noreferrer' target='_blank'>Phil Hawthorne</a> and <a href='https://twitter.com/rohank9' rel='noreferrer' target='_blank'>Rohan Karamandi</a> and we had a chat about <a href='https://materialdesignicons.com/' rel='noreferrer' target='_blank'>Material Design Icons</a>, how they work with <a href='https://www.home-assistant.io/' rel='noreferrer' target='_blank'>Home Assistant</a>, and all things home automation.</p>
            <Button
