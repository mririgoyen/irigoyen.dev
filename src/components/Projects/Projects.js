      ...
      <div className={classes.items}>
        ...
        <div className={classes.item}>
          ...
          <div className={classes.info}>
            ...
            <p>Accusoft has been participating in the <a onClick={scrollTo('philanthropy')}>Extra Life fundraiser</a> for the past several years. Every year, we hold a classic arcade tournament on game day to bring awareness to our fundraising efforts and to have a bit of fun.</p>
